...
global.ProjectName = 'seastore'; // 配置项目名称
global.ProjectPath = '/src/projects/www'; // 配置项目路径, 新项目需要配置
...
// mongoose.connect('mongodb://' + ProjectName + ':123456@localhost:27017/' + ProjectName);
...
// 静态资源配置
app.use('/www', express.static(__dirname + '/src/projects/www/assets'));
